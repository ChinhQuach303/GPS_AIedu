...
def run_sim_analysis_all_45():
    ...
    processed_path = '/home/chinh303/code/aiedu/data/processed/sim_data_all_45.csv'
    df.to_csv(processed_path, index=False)
    
    print(f"Running GPSBehaviorAnalysis on {len(df)} rows from all 45 questions...")
    analyzer = GPSBehaviorAnalysis(processed_path)
    report = analyzer.generate_report('/home/chinh303/code/aiedu/reports/simulated_all_45_analysis')
    print("\n--- Analysis Report Summary ---")
    print(report)

if __name__ == "__main__":
    run_sim_analysis_all_45()
