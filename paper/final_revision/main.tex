...
\paragraph{Cross-model stress test and expanded corpus.} The Phi-3 cross-model set contains 49 sessions and is used as a robustness stress test. The expanded exploratory corpus contains NA rows, but is not treated as a human gold standard because metric and schema audits still reveal inconsistencies.
